export const translations = {
  en: {
    ...
    webDesignNL: {
      /*
       * Solo lo que es IDÉNTICO en todas las landings por ciudad: labels,
       * placeholders y mensajes del formulario. El copy que cambia por
       * ciudad (hero, servicios, proceso, FAQ, SEO) vive en
       * src/data/landings — si viviera aquí, las landings serían
       * casi-duplicados y competirían entre ellas en Google.
       */
      leadForm: {
